...
public class GenreController {
    ...
    public ResponseEntity<Void> addGenreToBook(@PathVariable UUID genreId, @PathVariable UUID bookId) {
        genreService.addGenreToBook(bookId, genreId);
        return ResponseEntity.status(HttpStatus.CREATED).build();
    }

    @DeleteMapping("/{genreId}/books/{bookId}")
    public ResponseEntity<Void> removeGenreFromBook(@PathVariable UUID genreId, @PathVariable UUID bookId) {
